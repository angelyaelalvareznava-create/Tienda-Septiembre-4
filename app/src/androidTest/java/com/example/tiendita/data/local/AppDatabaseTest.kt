...
class AppDatabaseTest {
    ...
    fun duplicateUsernameIsRejected() = runBlocking {
    ...
    @Test(expected = SQLiteConstraintException::class)
    fun twoAccountsCannotShareSameEmployee() = runBlocking {
    ...
    @Test(expected = SQLiteConstraintException::class)
    fun duplicateSkuIsRejected() = runBlocking {
    ...
    @Test(expected = SQLiteConstraintException::class)
    fun sameProductInMovementIsRejected() = runBlocking {
    ...
    @Test
    fun employeeDeleteSetsNullOnAccount() = runBlocking {
    ...
    @Test(expected = SQLiteConstraintException::class)
    fun productDeleteRestrictedWhenStockExists() = runBlocking {
        val catId = db.productDao().insertCategory(CategoryEntity(name = "Drinks", description = null, createdAt = 1, updatedAt = 1))
